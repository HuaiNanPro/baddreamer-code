...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=read_eval_config, default=read_eval_config("/raid/zengchaolv/shuaizhe_vavam/VideoActionModel/configs/paths/eval_paths_jeanzay.yaml"))
