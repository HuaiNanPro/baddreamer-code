...
from video_prediction_nuscenes_mini.vam.utils import RankedLogger
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        for temporal_index in temporal_indices:
            ...
            if self.images_rootdir is not None:
                # get image - use images_rootdir + relative file_path
                file_path = os.path.join(self.images_rootdir, sample["file_path"])
            else:
                # get image - use absolute path directly from pickle
