...
--dataset nuscenes \
--queue sequential \
--frames_dir /raid/zengchaolv/shuaizhe_vavam/poisoned_2.5%_all \
--outdir /raid/zengchaolv/shuaizhe_vavam/poisoned_2.5%_all/tokens \
...
# Number of tokenized frames:$FILES_LIST_DIR
